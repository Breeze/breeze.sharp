...
namespace Breeze.Sharp {
  ...
  public class EntityType : StructuralType, IJsonSerializable {
    ...
    public void UpdateFromJNode(JNode jNode) {
      ...
      Check(et.IsAbstract, jNode.Get<bool>("isAbstract"), "IsAbstract");
    ...
    private static void Check(Object v1, Object v2, String name) {
      if (v1 == null && v2 == null) return;
      if (Object.Equals(v1, v2)) return;
      throw new Exception("Metadata does not match for property: " + name);
    }
